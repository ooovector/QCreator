...
Couplers=[elements.pp_transmon.PP_Transmon_Coupler('resonator_claw',0,0,16,'left',coupler_type = 'coupler',heightl = 0.3,
                                                   w=resonator_core,s=resonator_gap,g=resonator_ground)
         ]

Couplers_Squid=[elements.pp_squid_coupler.PP_Squid_Coupler('resonator_claw',0,0,16,'left',coupler_type = 'coupler',heightl = 0.3,
                                                   w=resonator_core,s=resonator_gap,g=resonator_ground)
         ]
...
capacitance_layers={'ground':0}# THIS is a fundamental rule that the ground should be in the zero layer

transmon1,capacitance_layers = elements.pp_squid_coupler.PP_Squid_C(name='PP_Transmon1',center=(2000,1250),
                          width = width,
                          height = height,
                          ...
                          capacitance_layers = capacitance_layers,
...
center = (2000,2950)
transmon2,capacitance_layers = elements.pp_transmon.PP_Transmon(name='PP_Transmon2',center=center,
                          width = width,
                          height = height,
                          bridge_gap = JJ_pad_offset_x,
                          bridge_w   = JJ_pad_offset_y ,
