...
sample = creator.Sample('Single_qubits_PP_mw_lines',layers_configuration)
...
logos=elements.WMILogos((-1500,0),(-1000,0),r'C:\Python\Github\QCreator\QCreator\elements\masks',layers_configuration)
sample.add(logos)
sample.draw_design()
#sample.watch()
