...
Coupler1=[elements.shoe_transmon.Shoe_Transmon_Coupler(0,0,16,'left',coupler_type = 'coupler',heightl = 0.3,
                                                   w=resonator_core,s=resonator_gap,g=resonator_ground)
         ]

Coupler2=[elements.shoe_transmon.Shoe_Transmon_Coupler(210,70,16,'top',coupler_type = 'coupler',heightl = 0.3,
                                                   w=resonator_core,s=resonator_gap,g=resonator_ground)
         ]

Coupler3=[elements.shoe_transmon.Shoe_Transmon_Coupler(0,0,16,'left',coupler_type = 'coupler',heightl = 0.3,
                                                   w=resonator_core,s=resonator_gap,g=resonator_ground)
         ]
...
transmon2 = elements.shoe_transmon.Shoe_Transmon(name='Shoe_Transmon2',center=(2050+ground_w+ground_w_tc-2*x_shift,2000),
                          ...
                          calculate_capacitance = False,
                          transformations = {},
                          remove_ground = {'right':1,'left':1,'top':1,'bottom':1},
                          shoes = shoes2,
                          )

transmon3 = elements.shoe_transmon.Shoe_Transmon(name='Shoe_Transmon3',center=(2050+2*ground_w+2*ground_w_tc-4*x_shift,2000),
                          width = width,
                          height = height,
                          bridge_gap = JJ_pad_offset_x,
                          bridge_w   = JJ_pad_offset_y ,
                          ...
                          Couplers = Coupler3,
                          calculate_capacitance = False,
                          transformations = {'rotate':(np.pi,(2050+2*ground_w+2*ground_w_tc-4*x_shift,2000))},
                          remove_ground={'right':1,'top':1},
                          shoes = shoes3,
                          )
