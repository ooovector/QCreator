...
class Fluxonium(DesignElement):
    ...
    def default_squid_params(self):
        ...
        squid_params[
            'capacity_angle'] = False  # If True the angle between capacities is 90. Work only for horizontal squid_orientation
        ...
        if squid_orientation == 'horizontal':
            ...
            if capacity_angle:
                extra_leads.extend([
                    ...
                    [[
                         outer_chain_position - squid_contact_extension + bottom_layer_overlap / 2 + bandage_offset - jj_lead_width / 2,
                         jj_lead_width / 2 - outer_chain_position + squid_contact_extension - bottom_layer_overlap / 2 - bandage_offset],
                     [
                         outer_chain_position - squid_contact_extension - bottom_layer_overlap / 2 - bandage_offset - jj_lead_width / 2,
                         jj_lead_width / 2 - outer_chain_position + squid_contact_extension + bottom_layer_overlap / 2 + bandage_offset]],
            ...
            extra_leads.extend([
                ...
                [[-bottom_layer_overlap / 2 - bandage_offset,
                  scaffold_height + vertical_orientation_detour + squid_contact_extension],
                 [bottom_layer_overlap / 2 + bandage_offset,
                  scaffold_height + vertical_orientation_detour + squid_contact_extension + bottom_layer_overlap + 2 * bandage_offset]]
            ])
        ...
        if self.squid_params['squid_orientation'] == 'horizontal':
            ...
            if capacity_angle:
                bandage_rectangles.extend([[
                    # left lead
                    [outer_chain_position - squid_contact_extension + bottom_layer_overlap / 2 - jj_lead_width / 2,
                     jj_lead_width / 2 - outer_chain_position + squid_contact_extension - bottom_layer_overlap / 2],
                    [outer_chain_position - squid_contact_extension - bottom_layer_overlap / 2 - jj_lead_width / 2,
                     jj_lead_width / 2 - outer_chain_position + squid_contact_extension + bottom_layer_overlap / 2 + 2 * bandage_offset]],
                    # right lead
        ...
        if self.squid_params['squid_orientation'] == 'horizontal':
            ...
            optical_litho_rectangles = [
                ...
                [[-self.flux_w / 2 - self.flux_s,
                  current_position - flux_line_return_wire_distance - flux_line_extent - 2 * bandage_offset],
                 # [-extent_horizontal,
                 [-self.flux_w / 2 - self.flux_s - self.flux_g,
                  # -self.g - self.s - self.w / 2]],
                  -self.g + current_position - flux_line_return_wire_distance - flux_line_extent - 2 * bandage_offset]],
                [[self.flux_w / 2 + self.flux_s,
                  current_position - flux_line_return_wire_distance - flux_line_extent - 2 * bandage_offset],
            ...
            if capacity_angle:
                optical_litho_rectangles.extend(
                    ...
                    [[[outer_chain_position - squid_contact_extension - jj_lead_width / 2 - self.w / 2,
                       jj_lead_width / 2 - outer_chain_position + squid_contact_extension
                       - bottom_layer_overlap / 2 + bandage_offset],
                      [outer_chain_position - squid_contact_extension - jj_lead_width / 2 + self.w / 2,
                       jj_lead_width / 2 - outer_chain_position + squid_contact_extension
                ...
                if self.invert_flux_line:
                    ...
                    flux_port_position_raw = [0, -self.g + current_position - flux_line_return_wire_distance
                                              - flux_line_extent - 2 * bandage_offset]
                port1_position_raw = [outer_chain_position - squid_contact_extension - jj_lead_width / 2,
                                      jj_lead_width / 2 - outer_chain_position + squid_contact_extension
                                      + bottom_layer_overlap / 2 + 3 * bandage_offset]
