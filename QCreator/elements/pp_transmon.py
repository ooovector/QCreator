...
class PP_Transmon(DesignElement):
    ...
    def __init__(self, name: str, center: Tuple[float, float],
        ...
        self.JJ = None
        self.cap_structures = {}
        self.capacitance_layers=capacitance_layers
        #terminals
    ...
    def render(self):
        ...
        if self.JJ_params['manhatten']:
            ...
            self.capacitance_layers.update('pp_1':self.capacitance_layers[-1])
        ...
        self.caplayers.update({'ground':self.layer_configuration.total_layer})
        ...
        if len(self.couplers) != 0:
            for id, coupler in enumerate(self.couplers):
                ...
                if coupler.coupler_type == 'coupler':
                        ...
                        self.caplayers.update({coupler.coupler_name:cap})
...
class PP_Transmon_Coupler:
    ...
    """
    def __init__(self, name,l1,l2,t,side = 'left',coupler_type = 'none',heightl = 1,heightr=1,w= None, g=None, s=None):
        self.l1 = l1
        self.l2 = l2
        self.t = t
        self.gap = s
